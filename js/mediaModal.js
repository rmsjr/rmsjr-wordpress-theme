...
/*
	...
	var Modal = function(element, options) {
		...
		this.fileUrl = options.linkData.relativeUrl;
		alert(options.linkData);
	...
	$.fn.modal = function (option, linkData, _relatedTarget) {
		return this.each(function () {
			var $this   = $(this);
			var data    = $this.data('bs.modal');
			var options = $.extend({}, _super.DEFAULTS, $this.data(), typeof option === 'object' && option, {'linkData':linkData});
